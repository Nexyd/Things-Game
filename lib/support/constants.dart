...
const String PRIMARY_COLOR = "things_game_primaryColor";
const String TEXT_COLOR = "things_game_textColor";
const String BACKGROUND_COLOR = "things_game_backgroundColor";
const String LANGUAGE = "things_game_language";
